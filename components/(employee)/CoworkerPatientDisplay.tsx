...
const CoworkerPatientDisplay = ({ patient, navigation, user }: Props) => {
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={() => navigation.navigate("CoworkerPatientInfo", { owner: owner, patient: patient, user: user })} disabled={owner == undefined || patient == undefined}>
      {owner ? (
        <>
...
export default CoworkerPatientDisplay;
